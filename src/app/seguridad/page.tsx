...
export default function Seguridad() {
    return (
        <motion.article
            ...
            <div className='flex items-start justify-start w-full px-4 container-wide lg:pl-9 text-4xl lg:text-8xl pb-10 lg:pb-24'>
            ...
            <section>
                ...
                >
                    ...
                    <LandingProductTourContent value="feature-2">
                        ...
                        <img src="/acido2.png" alt="Acrilico Nitrilo" className="w-full h-80 object-scale-down" />
                    </LandingProductTourContent>
